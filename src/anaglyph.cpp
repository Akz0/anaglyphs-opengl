...
static AnaglyphMode anaglyphMode = AnaglyphMode::ToeIn;
	...
	do
	{
		...
		if (anaglyphMode == None) {
			...
			if (anaglyphMode == ToeIn) {
				...
				// Calculate the direction vector between lookat and eyeCenter
				glm::vec3 lookDirection = glm::normalize(lookat - eyeCenter);
				// Calculate the distance from each eye to the convergence point
